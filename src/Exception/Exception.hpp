...
public:
    string what() override {
        return "\033[1;31mWoooahh your garden is so full.\n But, there is no room four your new plants. \033[0m";
    }
};
...
public:
    string what() override {
        return "\033[1;31mYour're a successful farmer! The barn is as crammed as rush hour traffic. Sadly, no room for additional animals.  \n \033[0m";
    }
};
