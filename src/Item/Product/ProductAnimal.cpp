...
ProductAnimal :: ProductAnimal (int animalproductID, string code, string name, string origin, int addedWeight, int price): Product(productID, code, name, "PRODUCT_ANIMAL", origin, addedWeight, priceProduct){}
...
SheepMeat :: SheepMeat(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", SheepMeat ::addedWeight, SheepMeat :: price){
...
HorseMeat :: HorseMeat(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", HorseMeat ::addedWeight, HorseMeat :: price){
...
RabbitMeat :: RabbitMeat(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", RabbitMeat ::addedWeight, RabbitMeat :: price){
...
SnakeMeat :: SnakeMeat(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", SnakeMeat ::addedWeight, SnakeMeat :: price){
...
CowMeat :: CowMeat(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", CowMeat ::addedWeight, CowMeat :: price){
...
ChickenMeat :: ChickenMeat(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", ChickenMeat ::addedWeight, ChickenMeat :: price){
...
ChickenEgg :: ChickenEgg(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", ChickenEgg ::addedWeight, ChickenEgg :: price){
...
DuckEgg :: DuckEgg(int addedWeight, int price): ProductAnimal(9, "COM", "COW_MEAT", "COW", DuckEgg ::addedWeight, DuckEgg :: price){
